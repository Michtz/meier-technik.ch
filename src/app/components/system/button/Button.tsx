...
export const ButtonGroup: React.FC<ButtonGroupProps> = ({
  ...
  useEffect(() => {
    ...
    if (ref.current.clientWidth <= singleNodeWidth * ref.current.childElementCount)
...
const ButtonGroupOption: React.FC<ButtonGroupOptionProps> = ({
  ...
  return <button type="button" {...sharedProps} onClick={handleButtonClick} disabled={disabled} />;
};
